...
class SimpleHTTPRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def list_directory(self, path):
        ...
        f.write(" <!DOCTYPE html>")
        f.write("            <html>")
        f.write("            <head><title>Directory listing for %s</title>\n" % displaypath)
        f.write("            <meta name='viewport' content='width=device-width, initial-scale=1'>")
        f.write("            <style>")
        f.write("            body {")
        f.write("                background: #555;")
        ...
        f.write("            <body>")
        f.write("")
        f.write("            <div class='content'> <h1> Temporary file upload </h1> <h2>Directory listing for %s</h2>\n" % displaypath)
        ...
        f.write("            <hr> <a href='logout'>Logout</a></div></body>")
        f.write("            </html>")
        length = f.tell()
        f.seek(0)
        self.send_response(200)
